...
#         "valgrind", "--error-exitcode=99", "--leak-check=full", EXECUTABLE, test_file
#     ], capture_output=True, text=True)

#     if result.returncode == 99:
#         print(f"{RED}[MEMORY ERROR]{RESET} {os.path.basename(test_file)}")
#         format_block("Valgrind Output", result.stderr.strip())
#         return False
#     else:
...
#     mode_msg = "Memory check" if VALGRIND_MODE else "Functional test"
